      ...
      >
        ...
        <div className="p-5 flex-1 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-4 gap-2 h-full">
            <button
              onClick={handleClear}
              className="col-span-2 p-4 text-center rounded-xl bg-zinc-800 text-red-400 font-medium active:scale-95 transition-transform"
            >
              C
            </button>
            <button
              onClick={handleBackspace}
              className="p-4 flex items-center justify-center rounded-xl bg-zinc-800 text-zinc-100 font-medium active:scale-95 transition-transform"
            >
              <Delete size={20} />
            </button>
            <button
              onClick={() => handleOperator("/")}
              className="p-4 text-center rounded-xl bg-brand text-zinc-950 font-bold text-xl active:scale-95 transition-transform"
            >
              ÷
            </button>
            ...
            <button
              ...
              className="p-4 text-center rounded-xl bg-zinc-800/50 text-zinc-100 font-medium text-xl active:scale-95 transition-transform"
            >
              7
            </button>
            <button
            ...
            <button
              ...
              className="col-span-2 p-4 text-center rounded-xl bg-zinc-800/50 text-zinc-100 font-medium text-xl active:scale-95 transition-transform"
            >
              0
            </button>
            <button
